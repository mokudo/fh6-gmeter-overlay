...
Data Outの加速度値は、FH6公式Data Outドキュメントの324 byte固定パケットに合わせ、`AccelerationX` を20 byte、`AccelerationY` を24 byte、`AccelerationZ` を28 byteから読み取っています。横Gは `AccelerationX`、前後Gは `AccelerationZ` を `9.80665` で割って表示します。
